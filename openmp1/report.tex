...
\end{verbatim}
In the function saveFrames(), all fot-loops can be parallelized simply in equal chunks and declaring the inner loop variables private.
...
\newpage
\appendix
\section {Appendix: Program code of piPar.c}} 
\label{app:piPar}
\begin{verbatim}
#include <stdlib.h>
#include <stdio.h>
...
\end{verbatim}
\section {Appendix: Program code of wavePar.c}} 
\label{app:wavePar}
\begin{verbatim}
